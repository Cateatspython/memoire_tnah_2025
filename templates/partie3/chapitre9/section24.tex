Nous avons développé des preuves de concept de visualisations pour des images à caractère scientifique, telles que des diagrammes astronomiques ou des figures géométriques. Toutefois, ces dernières peuvent être appliquées à tout corpus visant à étudier des motifs similaires entre différentes images pour retracer leur diffusion dans le temps et l'espace.
