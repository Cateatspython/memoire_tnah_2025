...
Cette visualisation nous permet d'avoir une vue générale de toutes les \textit{regions pairs} des deux \textit{witnesses}. Son but est de comparer les diagrammes de deux traditions de l'\almageste dans deux langues différentes à des époques distinctes.
...
\begin{figure}[H]
	...
	\caption{Les résultats de la reconnaissance automatique de similarités restent approximatifs}
