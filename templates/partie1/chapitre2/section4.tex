...
AIKON est une application de recherche \textit{open-source} conçue pour permettre aux chercheurs en sciences humaines et sociales d'exploiter des outils de computer vision afin d'analyser de vastes corpus de données historiques\footcite{Aikon2024}.
...
Le projet qui étudie les diagrammes astronomiques dans le but de retracer la diffusion et la transmission des savoirs en astronomie est le projet \gls{eida}. 
